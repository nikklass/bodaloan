...
//Add watermark
	...
	/*imagettftext($dst, $font_size, 0,  $base_width+1,$base_height+1,  $white, $font_path, $water_mark_text_2);
	imagettftext($dst, $font_size, 0, $base_width, $base_height,  $maroon, $font_path, $water_mark_text_2);*/
